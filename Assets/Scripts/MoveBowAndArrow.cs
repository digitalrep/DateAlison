...
public class MoveBowAndArrow : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log("Current level: " + GameObject.Find("StaticGameObject").transform.GetComponent<GameControl>().level);
        Debug.Log("Current question: " + GameObject.Find("StaticGameObject").transform.GetComponent<GameControl>().current_question);
